...
impl View for Manual {
    fn draw(&self, printer: &Printer) {
        let y_padding = 6;
            ...
            printer.print((0, y_padding + 7), &format!(" {:18} ", "→: right"));
            printer.print((0, y_padding + 8), &format!(" {:18} ", "d: right most"));
            printer.print((0, y_padding + 9), &format!(" {:18} ", "space: hard drop"));
            printer.print((0, y_padding + 10), &format!(" {:18} ", "m: stop and resume"));
            printer.print((0, y_padding + 11), &format!(" {:18} ", "n: new game"));
    }
